...
function ProfileInsideCabin({ profile, visible }: { profile: Profile; visible: boolean }) {
  return (
    <motion.div
      ...
      className="absolute inset-0 z-10 flex justify-center pt-20"
    >
      <div
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-[var(--black)] text-[var(--text)]">
      ...
      >
        ...
        <div className="pointer-events-none absolute left-1/2 top-2 z-40 flex -translate-x-1/2 flex-col items-start gap-3">
