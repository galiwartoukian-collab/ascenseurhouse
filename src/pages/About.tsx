      ...
      <section className="relative min-h-full w-full overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 flex min-h-full flex-col items-center text-center">
          <div className="relative h-[36vh] min-h-[210px] w-full sm:h-[38vh] md:h-[40vh] lg:h-[41vh]">
            ...
            <h2 className="font-display absolute inset-x-0 bottom-[-0.36em] mx-auto origin-bottom scale-y-[0.75] whitespace-nowrap px-[2vw] text-center text-[17.5vw] font-bold uppercase leading-[0.84] tracking-[-0.03em] text-white [-webkit-text-stroke:0.012em_currentColor]">
              ASCENSEUR HOUSE
            </h2>
          </div>

          <div className="relative mx-auto flex w-full max-w-[94rem] flex-1 flex-col items-center gap-[clamp(0.9rem,1.45vw,1.55rem)] px-5 pb-8 pt-[calc(clamp(1.55rem,3.1vw,3.45rem)+3.85vw)] text-center sm:px-8 sm:pb-10 md:px-12 md:pb-12">
